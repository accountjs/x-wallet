    ...
    <div className="py-3 px-7 bg-white rounded-t-2xl">
      <div className="flex justify-between items-center mb-5">
        ...
        <div className="flex items-center ">
          ...
          <img src={urlFormat('setting')} className="w-8 h-8 object-contain"></img>
        </div>
      </div>
            ...
            <div className="cursor-pointer">
              <CopyToClipboard text={address} onCopy={handleCopyAddress}>
                <svg
                  ...
                  fill="none"
                >
                  <rect x="0.5" y="0.5" width="8" height="11" fill="#F7F7F7" stroke="#DCDCDC" />
                  <rect x="3.5" y="3.5" width="8" height="11" fill="#F7F7F7" stroke="#DCDCDC" />
                </svg>
              </CopyToClipboard>
            </div>
          </div>
